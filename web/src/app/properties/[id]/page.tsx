...
export default async function PropertyDetailPage({ params }: { params: { id: string } }) {
  ...
  const [obligations, accounts, recurring, documents, parties] = await Promise.all([
    getObligationsForProperty(params.id),
    getAccountsForProperty(params.id),
    getRecurringRulesForProperty(params.id),
    getDocumentsForProperty(params.id),
    getPartiesForProperty(params.id),
  ])
