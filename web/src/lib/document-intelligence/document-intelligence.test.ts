...
const accounts = [
  { id: 'a-1', property_id: 'p-1', account_type: 'water', account_number: '3928292' },
  { id: 'a-2', property_id: 'p-1', account_type: 'electricity_gas', account_number: 'E-8833' },
]
...
describe('Semantic duplicate detection', () => {
  it('warns about same provider, account, and statement date', () => {
    ...
    const duplicates = detectSemanticDuplicates(extraction, candidates)
